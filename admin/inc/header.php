<div class="container-fluid bg-dark text-light p-3 d-flex align-items-center justify-content-between sticky-top"> 
    <h3 class="mb-0 h-font">JAJRT Mobile Shop</h3>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse show px-3 small mb-1" id="bookingLinks">
                            <ul class="nav nav-pills flex-column rounded border border-secondary">
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="new_order.php">New Order</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="refund_order.php">Refund Order</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="order_records.php">Order Records</a>
                                </li>
                            </ul>
                        </div>
                    </li>
